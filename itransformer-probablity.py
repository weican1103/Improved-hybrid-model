...
net1= iTransformer.Model(config).to(device)
...
net2= iTransformer.Model(config).to(device)
...
result_df.to_csv('实验二-data4-itransformer-概率预测95%.csv', index=False, encoding='utf-8')
# 打印保存成功的消息
